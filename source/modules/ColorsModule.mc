...
module ColorsModule {
    ...
    var ColorsMap =
        ...
        }) as Dictionary<ColorsTypes.ColorsTypesEnum, Number>;
    ...
    var TextsMap =
        ...
        }) as Dictionary<ColorsTypes.ColorsTypesEnum, ResourceId>;

    function getColor(key as ColorsTypes.ColorsTypesEnum) as Number {
        return ColorsMap.get(key) as Number;
    }

    function getColorName(key as ColorsTypes.ColorsTypesEnum) as ResourceId {
